...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1695.46, 4820.78, 42.07), width = 2, length = 2},
    [2] = {shopType = 'clothing', coords = vector3(-710.02, -152.85, 37.42), width = 2, length = 2},
    [3] = {shopType = 'clothing', coords = vector3(-1192.26, -768.06, 17.32), width = 2, length = 2},
    [4] = {shopType = 'clothing', coords = vector3(426.87, -808.18, 29.49), width = 2, length = 2},
    [5] = {shopType = 'clothing', coords = vector3(-162.658, -303.397, 38.733), width = 2, length = 2},
    [6] = {shopType = 'clothing', coords = vector3(74.32, -1390.85, 29.38), width = 2, length = 2},
    [7] = {shopType = 'clothing', coords = vector3(-821.28, -1071.69, 11.33), width = 2, length = 2},
    [8] = {shopType = 'clothing', coords = vector3(-1450.711, -236.83, 48.809), width = 2, length = 2},
    [9] = {shopType = 'clothing', coords = vector3(4.31, 6510.36, 31.88), width = 2, length = 2},
    [10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 2, length = 2},
    [11] = {shopType = 'clothing', coords = vector3(1198.44, 2711.17, 38.22), width = 2, length = 2},
    [12] = {shopType = 'clothing', coords = vector3(-3171.453, 1043.857, 19.863), width = 2, length = 2},
    [13] = {shopType = 'clothing', coords = vector3(-1100.7, 2712.79, 19.11), width = 2, length = 2},
    [14] = {shopType = 'clothing', coords = vector3(-1207.65, -1456.88, 4.3784737586975), width = 2, length = 2},
    [15] = {shopType = 'clothing', coords = vector3(125.06, -224.46, 54.56), width = 2, length = 2},
...
Config.ClothingRooms = {
    ...
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(300.81, -597.24, 43.28), width = 2, length = 2, cameraLocation = vector4(300.81, -597.24, 43.28, 345.67)}, -- Right double door in Hospital Map that is on QBCore GitHub
